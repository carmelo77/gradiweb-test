...
export default function ModalComponent({ modalConfirm, setModalConfirm, sendProductCart }) {
			...
			<div className="relative px-4 w-full max-w-xl h-full md:h-auto">
					<div className="relative py-12 bg-white rounded-lg shadow dark:bg-gray-700">
						...
						<div className="p-6 pt-0 text-center">
								...
								<h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want this product in the cart?</h3>
								<button 
									data-modal-toggle="popup-modal" 
									type="button" 
